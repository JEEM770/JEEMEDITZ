  ...
  return (
    <div className="min-h-screen pt-24">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="orb orb-primary w-[500px] h-[500px] -top-40 -left-40 opacity-50" />
        <div className="orb orb-accent w-[300px] h-[300px] bottom-0 right-0 opacity-40" style={{ animationDelay: '-8s' }} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-center lg:justify-end animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="relative group">
                <div className="absolute -inset-2 bg-gradient-to-r from-primary via-accent to-primary rounded-3xl blur-2xl opacity-40 group-hover:opacity-60 transition-opacity duration-500" />
                <img
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="card-glass group border-l-4 border-l-primary">
              <CardHeader>
                <CardTitle className="flex items-center space-x-4">
                  <span className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 group-hover:shadow-[0_0_25px_hsl(var(--primary)/0.3)] transition-all duration-500">
            ...
            <Card className="card-glass group border-l-4 border-l-accent">
              <CardHeader>
                <CardTitle className="flex items-center space-x-4">
                  <span className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center group-hover:bg-accent/20 group-hover:shadow-[0_0_25px_hsl(var(--accent)/0.3)] transition-all duration-500">
            ...
            {experiences.map((exp, index) => {
              ...
              return (
                ...
                >
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-4">
                      <span className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 group-hover:shadow-[0_0_30px_hsl(var(--primary)/0.3)] transition-all duration-500">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-primary font-mono font-bold">{animatedValues[key] || 0}%</span>
                      </div>
                      <Progress 
            ...
            {skills.map((skill, index) => {
              ...
              return (
                <div 
                  key={skill.name}
                  ref={(el) => (sectionRefs.current[key] = el)}
                  className="space-y-4 p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border transition-all duration-500 hover:bg-card hover:border-primary/30 hover:shadow-[0_0_30px_hsl(var(--primary)/0.1)] group"
                >
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="orb orb-primary w-[400px] h-[400px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-30" />
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <blockquote className="text-xl md:text-2xl text-muted-foreground leading-relaxed p-10 rounded-3xl bg-card/30 backdrop-blur-sm border border-border">
          ...
          <div className="mt-10 text-gradient font-bold text-2xl">— JEEM</div>
        </div>
      </section>
    </div>
  );
