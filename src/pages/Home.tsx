          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-hero">
                <AnimatedText text="Visual Storyteller" className="block" />
                <AnimatedText text="& Creative Director" className="block" delay={300} />
              </h1>
              <ScrollReveal delay={600}>
                <p className="text-xl text-muted-foreground leading-relaxed">
                  I'm <span className="text-primary font-semibold glow-text">JEEM</span>, an 18-year-old passionate video editor,
            ...
            <ScrollReveal delay={800}>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild size="lg" className="glow animate-pulse-glow transition-cinematic hover:scale-105 shimmer-button">
                  <Link to="/portfolio">
                    <Play className="w-5 h-5 mr-2" />
                    View My Work
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="transition-cinematic hover:scale-105 hover:border-primary">
                  <Link to="/about">
                    Learn More
            ...
            <ScrollReveal delay={1000}>
              <div className="grid grid-cols-3 gap-6 pt-8 border-t border-border">
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary glow-text">50+</div>
                  <div className="text-sm text-muted-foreground">Projects</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary glow-text">8</div>
                  <div className="text-sm text-muted-foreground">Years Experience</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary glow-text">100%</div>
            ...
            <ScrollReveal delay={400}>
              <div className="relative">
                ...
                <img
                  ...
                  className="relative w-80 h-80 lg:w-96 lg:h-96 object-cover rounded-full border-4 border-primary/30 cinematic-shadow animate-float"
                />
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 stagger-children">
            {skills.map((skill, index) => (
              <ScrollReveal key={skill.name} delay={index * 150}>
                <HoverCard3D>
                  <ElectricBorder>
                    <Card className="card-gradient border-0 h-full">
                      <CardContent className="p-6 text-center">
                        ...
                        <div className="text-primary font-medium mb-2 glow-text">{skill.years}</div>
